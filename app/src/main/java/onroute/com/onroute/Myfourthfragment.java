...
public class Myfourthfragment extends Fragment {
    ...
    public  String[] TITLESS = new String[20];
    public  String[] URLS = new String[20];
    public static final String[] TITLES = new String[20];
    public static final String[] URL = new String[20];
    private static String url = "https://www.googleapis.com/youtube/v3/search?key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8&channelId=UC6xOVUMstTf08rUgOFbyPEA&part=snippet,id&order=date&maxResults=50";
    private static String url3 = "https://www.googleapis.com/youtube/v3/playlists?part=snippet&channelId=UC6xOVUMstTf08rUgOFbyPEA&key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8";
    ArrayList<String> TITLESS3 = new ArrayList<String>();
    public  String[] URLS3 = new String[20];
    ArrayList<String> TITLESS4 = new ArrayList<String>();
    public  String[] URLS4 = new String[50];
    ArrayList<String> TITLESS5 = new ArrayList<String>();
    public  String[] URLS5 = new String[20];
    public  String[] playlists = new String[20];
   // public  String[] playlists2 = new String[9];
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        View view= inflater.inflate(R.layout.fragment_myfourthfragment, container, false);
...
return view;
   ...
   /* private void initViews() {
    ...
    private class GetVideostwo extends AsyncTask<Void, Void, Void> {
        ...
        //https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId="+playlist[i]+"&key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8"
        // ImageView im=(ImageView)findViewById(R.id.imageView);
        private  String url1 = "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId=PLzCPLavhafh3s_9q4tc2JW4Dz1X_15C0G&key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8";
        protected Void doInBackground(Void... arg0) {
            // Creating service handler class instance
            ServiceHandler sh = new ServiceHandler();
    ...
    private class GetVideosthree extends AsyncTask<Void, Void, Void> {
        ...
        //https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId="+playlist[i]+"&key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8"
        // ImageView im=(ImageView)findViewById(R.id.imageView);
        private  String url1 = "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId=PLzCPLavhafh1nHadcr9y9KqOPcIRnQzju&key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8";
        protected Void doInBackground(Void... arg0) {
            // Creating service handler class instance
            ServiceHandler sh = new ServiceHandler();
    ...
    private class GetVideosfour extends AsyncTask<Void, Void, Void> {
        ...
        //https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId="+playlist[i]+"&key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8"
        // ImageView im=(ImageView)findViewById(R.id.imageView);
        private  String url1 = "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId=PLzCPLavhafh1E2pDVEZADAJTTicp8dugK&key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8";
        protected Void doInBackground(Void... arg0) {
            // Creating service handler class instance
            ServiceHandler sh = new ServiceHandler();
    ...
    private class GetVideos extends AsyncTask<Void, Void, Void> {
        ...
        //https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId="+playlist[i]+"&key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8"
        // ImageView im=(ImageView)findViewById(R.id.imageView);
        private  String url1 = "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId=PLzCPLavhafh0jECtK8pejIDiSZ88rT4Jv&key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8";
        protected Void doInBackground(Void... arg0) {
            // Creating service handler class instance
            ServiceHandler sh = new ServiceHandler();
