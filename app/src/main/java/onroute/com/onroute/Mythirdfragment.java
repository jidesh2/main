...
public class Mythirdfragment extends Fragment {
    ...
    private static String url = "https://www.googleapis.com/youtube/v3/search?key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8&channelId=UCpEhnqL0y41EpW2TvWAHD7Q&part=snippet,id&order=date&maxResults=50";
    private static String url3 = "https://www.googleapis.com/youtube/v3/playlists?part=snippet&channelId=UCpEhnqL0y41EpW2TvWAHD7Q&key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8";
   ...
   // public  String[] playlists2 = new String[9];
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        View view= inflater.inflate(R.layout.fragment_mythirdfragment, container, false);
...
return view;
   ...
   /* private void initViews() {
    ...
    private class GetVideostwo extends AsyncTask<Void, Void, Void> {
        ...
        //https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId="+playlist[i]+"&key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8"
        // ImageView im=(ImageView)findViewById(R.id.imageView);
        private  String url1 = "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId=PLzufeTFnhupyAdEpRtfw5S3q7yU12Q1_W&key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8";
        protected Void doInBackground(Void... arg0) {
            // Creating service handler class instance
            ServiceHandler sh = new ServiceHandler();
    ...
    private class GetVideosthree extends AsyncTask<Void, Void, Void> {
        ...
        //https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId="+playlist[i]+"&key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8"
        // ImageView im=(ImageView)findViewById(R.id.imageView);
        private  String url1 = "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId=PLzufeTFnhupxM6blFNznCEKCLQ6biK_d3&key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8";
        protected Void doInBackground(Void... arg0) {
            // Creating service handler class instance
            ServiceHandler sh = new ServiceHandler();
    ...
    private class GetVideosfour extends AsyncTask<Void, Void, Void> {
        ...
        //https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId="+playlist[i]+"&key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8"
        // ImageView im=(ImageView)findViewById(R.id.imageView);
        private  String url1 = "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId=PLzufeTFnhupzBi22rTZgQbnRMWVCrUEvP&key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8";
        protected Void doInBackground(Void... arg0) {
            // Creating service handler class instance
            ServiceHandler sh = new ServiceHandler();
    ...
    private class GetVideos extends AsyncTask<Void, Void, Void> {
        ...
        //https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId="+playlist[i]+"&key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8"
        // ImageView im=(ImageView)findViewById(R.id.imageView);
        private  String url1 = "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId=PLzufeTFnhupyFjNWbjUCMHWDXf1x3XOpC&key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8";
        protected Void doInBackground(Void... arg0) {
            // Creating service handler class instance
            ServiceHandler sh = new ServiceHandler();
