...
public class MasonryGridView extends ScrollView {
    ...
    public MasonryGridView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet.getAttributeIntValue("app", "column", 6));
    }
