...
public class MytopgearFragment extends Fragment {
    ...
    private static String url = "https://www.googleapis.com/youtube/v3/search?key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8&channelId=UCjOl2AUblVmg2rA_cRgZkFg&part=snippet,id&order=date&maxResults=50";
    private static String url3 = "https://www.googleapis.com/youtube/v3/playlists?part=snippet&channelId=UCjOl2AUblVmg2rA_cRgZkFg&key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8";
   ...
   // public  String[] playlists2 = new String[9];
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        View view= inflater.inflate(R.layout.fragmenttopgear, container, false);
...
return view;
   ...
   /* private void initViews() {
    ...
    private class GetVideostwo extends AsyncTask<Void, Void, Void> {
        ...
        //https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId="+playlist[i]+"&key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8"
        // ImageView im=(ImageView)findViewById(R.id.imageView);
        private  String url1 = "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId=PLVf811yyyVnNTAhR5PEybVgK6L-uHqLC-&key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8";
        protected Void doInBackground(Void... arg0) {
            // Creating service handler class instance
            ServiceHandler sh = new ServiceHandler();
    ...
    private class GetVideosthree extends AsyncTask<Void, Void, Void> {
        ...
        //https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId="+playlist[i]+"&key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8"
        // ImageView im=(ImageView)findViewById(R.id.imageView);
        private  String url1 = "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId=PLVf811yyyVnNpDuZeIiw2MgbwwNUnRpTx&key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8";
        protected Void doInBackground(Void... arg0) {
            // Creating service handler class instance
            ServiceHandler sh = new ServiceHandler();
    ...
    private class GetVideosfour extends AsyncTask<Void, Void, Void> {
        ...
        //https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId="+playlist[i]+"&key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8"
        // ImageView im=(ImageView)findViewById(R.id.imageView);
        private  String url1 = "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId=PLVf811yyyVnOrZTrT_pVcO8ReC1WCqRaW&key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8";
        protected Void doInBackground(Void... arg0) {
            // Creating service handler class instance
            ServiceHandler sh = new ServiceHandler();
    ...
    private class GetVideos extends AsyncTask<Void, Void, Void> {
        ...
        //https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId="+playlist[i]+"&key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8"
        // ImageView im=(ImageView)findViewById(R.id.imageView);
        private  String url1 = "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId=PLVf811yyyVnORW0bhNH4SY_-0dnkvyP7L&key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8";
        protected Void doInBackground(Void... arg0) {
            // Creating service handler class instance
            ServiceHandler sh = new ServiceHandler();
