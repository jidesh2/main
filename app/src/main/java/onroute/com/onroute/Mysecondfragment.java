...
public class Mysecondfragment extends Fragment {
    ...
    private static String url = "https://www.googleapis.com/youtube/v3/search?key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8&channelId=UC82o9tQyo_cJhtyoFi-ROEw&part=snippet,id&order=date&maxResults=50";
    private static String url3 = "https://www.googleapis.com/youtube/v3/playlists?part=snippet&channelId=UC82o9tQyo_cJhtyoFi-ROEw&key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8";
    ...
    public  String[] URLS4 = new String[200];
   ...
   // public  String[] playlists2 = new String[9];
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        View view= inflater.inflate(R.layout.fragment_mysecondfragment, container, false);
       tct=(TextView)view.findViewById(R.id.textView4);
...
return view;
   ...
   /* private void initViews() {
    ...
    private class GetVideostwo extends AsyncTask<Void, Void, Void> {
        ...
        //https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId="+playlist[i]+"&key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8"
        // ImageView im=(ImageView)findViewById(R.id.imageView);
        private  String url1 = "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId=PLu-K45j6-YpDq3DEwCzs65RR6UgBjnJ-m&key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8";
        protected Void doInBackground(Void... arg0) {
            // Creating service handler class instance
            ServiceHandler sh = new ServiceHandler();
    ...
    private class GetVideosthree extends AsyncTask<Void, Void, Void> {
        ...
        //https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId="+playlist[i]+"&key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8"
        // ImageView im=(ImageView)findViewById(R.id.imageView);
        private  String url1 = "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId=PLu-K45j6-YpANvO2cD3imnknhEEek-Qo_&key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8";
        protected Void doInBackground(Void... arg0) {
            // Creating service handler class instance
            ServiceHandler sh = new ServiceHandler();
    ...
    private class GetVideosfour extends AsyncTask<Void, Void, Void> {
        ...
        //https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId="+playlist[i]+"&key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8"
        // ImageView im=(ImageView)findViewById(R.id.imageView);
        private  String url1 = "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId=PLu-K45j6-YpBL5SpBMUYom0i1w7zvWP-k&key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8";
        protected Void doInBackground(Void... arg0) {
            // Creating service handler class instance
            ServiceHandler sh = new ServiceHandler();
    ...
    private class GetVideos extends AsyncTask<Void, Void, Void> {
        ...
        //https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId="+playlist[i]+"&key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8"
        // ImageView im=(ImageView)findViewById(R.id.imageView);
        private  String url1 = "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId=PLu-K45j6-YpCBPdHsQzGwKTGLsZeV5-fZ&key=AIzaSyDKi3za0bU_sRbMTow3n2qnaGludVR_XO8";
        protected Void doInBackground(Void... arg0) {
            // Creating service handler class instance
            ServiceHandler sh = new ServiceHandler();
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
                ...
                try {
                    ...
                    for(int i=0; i<50; i++) {
                        ...
                        for(int k=1;k<=3;k++){
                            ...
                            JSONObject jobj2 = snip.getJSONObject("thumbnails");
                            JSONObject jobj3= jobj2.getJSONObject("medium");
                            String titleobj = snip.getString("title");
                            Name[i]=titleobj;
        ...
        protected void onPostExecute(Void result) {
            ...
            TextView tct=(TextView)getView().findViewById(R.id.textView4);
            tct.setText(Name[1]);
        }
